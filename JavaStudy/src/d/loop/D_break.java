...
public class D_break {
	/*
	 * break; : 반복문, switch문 안에서 사용되는 분기문 break;가 실행되는 순간 현재 속해있는 반복문 또는 switch문을
	 * 강제로 탈출
	 */
	public static void main(String[] args) {
		...
		/*
		 * 
		 * // 랜덤값(1 ~ 100) 발생시키고 그 랜덤값을 출력(이 과정을 계속 반복) // 단, 발생한 값이 3의 배수일 경우 반복문을 종료
		 * 
		 * while(true) { int random = (int)(Math.random() * 100 + 1);
		 * System.out.print(random + "\t"); if(random % 3 == 0) { break; } }
		 * 
		 */
