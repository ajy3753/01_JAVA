...
public class Operator4 {
	/*
	 * 비교연산자 / 관계연산자 두 값을 비교하는 연산자 비교연산자는 조건을 만족하면 true(참), 만족하지 않으면 false(거짓)을 반환
	 * 즉, 비교연산의 결과는 논리값
	 * 
	 * 대소비교연산 : < > <= >= 동등비교연산 : == !=
	 * 
	 ...
	 * 
	 * String(문자열)은 단순하게 ==로 동등비교할 수 없다. 이유는 참조변수(객체를 담는 변수)이기 때문에
	 * 
	 * String 비교 시에는 문자열.equals(문자열);
	 */
